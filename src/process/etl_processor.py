...
class EtlProcessor:
    ...
    def extract_data(self):
        ...
        time.sleep(2)
        raw_data = self.extract_service.extract_complete_tickets_data(limit=100)
    ...
    def transform_data(self, extracted_data):
        ...
        self.transformed_data = self.transforme_service.transform_tickets_batch(extracted_data=extracted_data)
